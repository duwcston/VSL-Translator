        ...
        {Object.keys(results).length > 0 ? (
          <div className="space-y-6">
                  ...
                  {Object.values(results)[0]?.fps && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">
                        Frame:{" "}
                        {Math.round(
                          currentTime * (Object.values(results)[0]?.fps || 30),
                        )}
                      </span>
                    </div>
                  )}
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-semibold text-green-700">
                      Found {currentFrameDetections.length} sign
                      {currentFrameDetections.length > 1 ? "s" : ""}
                    </span>
                  </div>
            ...
            {Object.values(results)[0]?.type === "image" &&
              Object.values(results)[0]?.detections && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  {Array.isArray(Object.values(results)[0].detections) ? (
                    <div className="space-y-2">
                      {(
                        Object.values(results)[0].detections as Detection[]
                      ).map((detection, index) => (
                        <motion.div
                          key={index}
                          initial={{ opacity: 0, x: -20 }}
